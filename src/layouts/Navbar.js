...
const Navbar = () => {
    ...
    return (
        <div className={classes.grow}>
            <AppBar position="static" style={{ backgroundColor: 'rgb(20,25,33)' }}>
                <Toolbar>
                    <IconButton
                        edge="start"
                    ...
                    <div className={classes.sectionDesktop}>
                        ...
                        <div style={{ paddingRight: '40px' }} onClick={(handleOrer) => { alert('clicked') }}>
                            ...
                            <p style={{ margin: '-10px' }} > Account & Lists</p>
                        </div>
                        <div className={classes.ordermenu} onClick={(handleOrer) => { alert('clicked') }}>
                            <p style={{ paddingRight: "5px", fontSize: "small" }}>Return</p>
                            <p style={{ margin: '-10px' }} >  & Orders</p>
                        </div>
                        {/* <Button color="inherit">Return & orders</Button> */}
                        <IconButton
                            edge="end"
                            aria-label="account of current user"
